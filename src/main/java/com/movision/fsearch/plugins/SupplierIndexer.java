...
import com.movision.fsearch.util.Factor;
import com.movision.fsearch.util.FormulaUtil;
import com.movision.fsearch.service.MemberService;
import com.movision.fsearch.service.dao.MemberDao;
...
public class SupplierIndexer implements Indexer {
    ...
    public Path fullIndex(Searcher searcher) throws Exception {
        ...
        try {
            ...
            while (true) {
                Object[] params = null;
                String sql = "select id,mobile,email,registerTime,if(status=10,'已认证','未认证') authinfo,identify,enterpriseName,province,city,address,enterpriseType,"
